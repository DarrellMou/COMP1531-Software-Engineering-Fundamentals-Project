...
def setup_user():
    ...
    a_u_id1 = auth_register_v2('user1@email.com', 'User1_pass!', 'user1_first', 'user1_last')
    a_u_id2 = auth_register_v2('user2@email.com', 'User2_pass!', 'user2_first', 'user2_last')
    a_u_id3 = auth_register_v2('user3@email.com', 'User3_pass!', 'user3_first', 'user3_last')
    a_u_id4 = auth_register_v2('user4@email.com', 'User4_pass!', 'user4_first', 'user4_last')
    a_u_id5 = auth_register_v2('user5@email.com', 'User5_pass!', 'user5_first', 'user5_last')
...
def test_admin_user_remove_only_channel_owner():
    ...
    channel_join_v2(users['user1']['token'], channel_id2)
