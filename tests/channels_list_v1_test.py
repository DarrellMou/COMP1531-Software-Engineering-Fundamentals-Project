...
def test_multiple_channels_owner():
    ...
    chid5 = channels_create_v1(a_u_id2['auth_user_id'], 'channel5', True) #Public channel5 created, owner: user2
    chid6 = channels_create_v1(a_u_id2['auth_user_id'], 'channel6', True) #Public channel6 created, owner: user2
...
def test_multiple_channels_regmember():
    ...
    chid5 = channels_create_v1(a_u_id1['auth_user_id'], 'channel5', True) #Public channel5 created, owner: user1
    chid6 = channels_create_v1(a_u_id1['auth_user_id'], 'channel6', True) #Public channel6 created, owner: user1
    chid7 = channels_create_v1(a_u_id1['auth_user_id'], 'channel7', True) #Public channel7 created, owner: user1
    channel_join_v1(a_u_id2['auth_user_id'], chid2['channel_id']) #User 2 joins channel 2 as regular member
