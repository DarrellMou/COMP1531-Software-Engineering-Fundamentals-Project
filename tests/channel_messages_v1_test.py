...
def add_50_messages():
    ...
    while message_count < 50:
        ...
        if message_num % 2 == 1:
            message = {'message_id': message_num, 'u_id': 1, 'message': str(message_num), 'time_created': message_num}
        else:
            message = {'message_id': message_num, 'u_id': 2, 'message': str(message_num), 'time_created': message_num}
...
def test_channel_messages_v1_InputError_invalid_channel():
    ...
    with pytest.raises(InputError):
        assert channel_messages_v1(1, 2, 0)
...
def test_channel_messages_v1_InputError_invalid_start():
    # Add member 1 into channel 1 and add 1 message
    # Data is already reset in add_1_message()
    data = add_1_message() # Only has 1 message
...
def test_channel_messages_v1_no_messages():
    ...
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 0)['messages'][0]
...
def test_channel_messages_v1_1_message():
    ...
    assert channel_messages_v1(1, 1, 0)['end'] == -1, "The most recent message has been reached - return 'end': -1"
    assert channel_messages_v1(1, 1, 0)['messages'][0] == {'message_id': 1, 'u_id': 1, 'message': "Test message", 'time_created': 1}

    # Raise an index error if trying to access beyond index 0 of ['messages']
    # as index 1 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 0)['messages'][1]
...
def test_channel_messages_v1_50_messages():
    # Add members 1 and 2 into channel 1 and add 50 messages with the message just being the message id
    # Data is already reset in add_50_messages()
    data = add_50_messages()
    ...
    {'message_id': 46, 'u_id': 2, 'message': '46', 'time_created': 46},
    {'message_id': 45, 'u_id': 1, 'message': '45', 'time_created': 45},
    {'message_id': 44, 'u_id': 2, 'message': '44', 'time_created': 44},
    {'message_id': 43, 'u_id': 1, 'message': '43', 'time_created': 43},
    {'message_id': 42, 'u_id': 2, 'message': '42', 'time_created': 42},
    {'message_id': 41, 'u_id': 1, 'message': '41', 'time_created': 41},
    {'message_id': 40, 'u_id': 2, 'message': '40', 'time_created': 40},
    {'message_id': 39, 'u_id': 1, 'message': '39', 'time_created': 39},
    {'message_id': 38, 'u_id': 2, 'message': '38', 'time_created': 38},
    {'message_id': 37, 'u_id': 1, 'message': '37', 'time_created': 37},
    {'message_id': 36, 'u_id': 2, 'message': '36', 'time_created': 36},
    {'message_id': 35, 'u_id': 1, 'message': '35', 'time_created': 35},
    {'message_id': 34, 'u_id': 2, 'message': '34', 'time_created': 34},
    {'message_id': 33, 'u_id': 1, 'message': '33', 'time_created': 33},
    {'message_id': 32, 'u_id': 2, 'message': '32', 'time_created': 32},
    {'message_id': 31, 'u_id': 1, 'message': '31', 'time_created': 31},
    {'message_id': 30, 'u_id': 2, 'message': '30', 'time_created': 30},
    {'message_id': 29, 'u_id': 1, 'message': '29', 'time_created': 29},
    {'message_id': 28, 'u_id': 2, 'message': '28', 'time_created': 28},
    {'message_id': 27, 'u_id': 1, 'message': '27', 'time_created': 27},
    {'message_id': 26, 'u_id': 2, 'message': '26', 'time_created': 26},
    {'message_id': 25, 'u_id': 1, 'message': '25', 'time_created': 25},
    {'message_id': 24, 'u_id': 2, 'message': '24', 'time_created': 24},
    {'message_id': 23, 'u_id': 1, 'message': '23', 'time_created': 23},
    {'message_id': 22, 'u_id': 2, 'message': '22', 'time_created': 22},
    {'message_id': 21, 'u_id': 1, 'message': '21', 'time_created': 21},
    {'message_id': 20, 'u_id': 2, 'message': '20', 'time_created': 20},
    {'message_id': 19, 'u_id': 1, 'message': '19', 'time_created': 19},
    {'message_id': 18, 'u_id': 2, 'message': '18', 'time_created': 18},
    {'message_id': 17, 'u_id': 1, 'message': '17', 'time_created': 17},
    {'message_id': 16, 'u_id': 2, 'message': '16', 'time_created': 16},
    {'message_id': 15, 'u_id': 1, 'message': '15', 'time_created': 15},
    {'message_id': 14, 'u_id': 2, 'message': '14', 'time_created': 14},
    {'message_id': 13, 'u_id': 1, 'message': '13', 'time_created': 13},
    {'message_id': 12, 'u_id': 2, 'message': '12', 'time_created': 12},
    {'message_id': 11, 'u_id': 1, 'message': '11', 'time_created': 11},
    {'message_id': 10, 'u_id': 2, 'message': '10', 'time_created': 10},
    {'message_id': 9, 'u_id': 1, 'message': '9', 'time_created': 9},
    {'message_id': 8, 'u_id': 2, 'message': '8', 'time_created': 8},
    {'message_id': 7, 'u_id': 1, 'message': '7', 'time_created': 7},
    {'message_id': 6, 'u_id': 2, 'message': '6', 'time_created': 6},
    {'message_id': 5, 'u_id': 1, 'message': '5', 'time_created': 5},
    {'message_id': 4, 'u_id': 2, 'message': '4', 'time_created': 4},
    {'message_id': 3, 'u_id': 1, 'message': '3', 'time_created': 3},
    {'message_id': 2, 'u_id': 2, 'message': '2', 'time_created': 2},
    {'message_id': 1, 'u_id': 1, 'message': '1', 'time_created': 1}
...
def test_channel_messages_v1_48_messages():
    ...
    del data['channels'][0]['messages'][48:50] # This deletes index 48 and 49 (id 49 and 50)

    assert channel_messages_v1(1, 1, 0)['start'] == 0, "Start should not change"
    assert channel_messages_v1(1, 1, 0)['end'] == -1, "48 < start + 50 so the funtion should return 'end': -1"
    assert channel_messages_v1(1, 1, 0)['messages'][47] == {'message_id': 1, 'u_id': 1, 'message': '1', 'time_created': 1}
    assert channel_messages_v1(1, 1, 0)['messages'][0] == {'message_id': 48, 'u_id': 2, 'message': '48', 'time_created': 48}

    # Raise an index error if trying to access beyond index 47 of ['messages']
    # as index 50 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 0)['messages'][48]
...
def test_channel_messages_v1_51_messages():
    ...
    data['channels'][0]['messages'].append(message_51)

    assert channel_messages_v1(1, 1, 0)['start'] == 0, "Start should not change"
    assert channel_messages_v1(1, 1, 0)['end'] == 50, "51 > start + 50 so the funtion should return 'end': 50"
    assert channel_messages_v1(1, 1, 0)['messages'][49] == {'message_id': 2, 'u_id': 2, 'message': '2', 'time_created': 2}
    assert channel_messages_v1(1, 1, 0)['messages'][0] == {'message_id': 51, 'u_id': 1, 'message': "51", 'time_created': 51}
...
def test_channel_messages_v1_111_messages_start_0():
    ...
    data = add_111_messages()

    assert channel_messages_v1(1, 1, 0)['start'] == 0, "Start should not change"
    assert channel_messages_v1(1, 1, 0)['end'] == 50, "111 > start + 50 - function should return 'end': 50"
    assert len(channel_messages_v1(1, 1, 0)['messages']) == 50, "function should return 50 messages max"
    assert channel_messages_v1(1, 1, 0)['messages'][0] == {'message_id': 111, 'u_id': 1, 'message': "111", 'time_created': 111}
    assert channel_messages_v1(1, 1, 0)['messages'][25] == {'message_id': 86, 'u_id': 2, 'message': '86', 'time_created': 86}
    assert channel_messages_v1(1, 1, 0)['messages'][49] == {'message_id': 62, 'u_id': 2, 'message': '62', 'time_created': 62}
...
def test_channel_messages_v1_111_messages_start_50():
    ...
    assert channel_messages_v1(1, 1, 50)['messages'][25] == {'message_id': 36, 'u_id': 2, 'message': "36", 'time_created': 36}
    assert channel_messages_v1(1, 1, 50)['messages'][49] == {'message_id': 12, 'u_id': 2, 'message': '12', 'time_created': 12}

    # Raise an index error if trying to access beyond index 49 of ['messages']
    # as index 50 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 50)['messages'][50]
...
def test_channel_messages_v1_111_messages_start_100():
    ...
    assert channel_messages_v1(1, 1, 100)['start'] == 100, "Start should not change"
    assert channel_messages_v1(1, 1, 100)['end'] == -1, "111 < start + 50 - function should return 'end': -1"
    assert len(channel_messages_v1(1, 1, 100)['messages']) == 11, "function should return remaining 11 messages"
    assert channel_messages_v1(1, 1, 100)['messages'][0] == {'message_id': 11, 'u_id': 1, 'message': "11", 'time_created': 11}
    assert channel_messages_v1(1, 1, 100)['messages'][5] == {'message_id': 6, 'u_id': 2, 'message': '6', 'time_created': 6}
    assert channel_messages_v1(1, 1, 100)['messages'][10] == {'message_id': 1, 'u_id': 1, 'message': '1', 'time_created': 1}

    # Raise an index error if trying to access beyond index 10 of ['messages']
    # as index 11 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 100)['messages'][11]
...
def test_channel_messages_v1_start_21():
    ...
    assert channel_messages_v1(1, 1, 21)['start'] == 21, "Start should not change"
    assert channel_messages_v1(1, 1, 21)['end'] == 71, "End = start + 50 if the least recent message is not returned"

    # The 22nd most recent message of the whole channel is the first one to be returned
    assert channel_messages_v1(1, 1, 21)['messages'][0] == {'message_id': 90, 'u_id': 2, 'message': '90', 'time_created': 90}
    assert channel_messages_v1(1, 1, 21)['messages'][25] == {'message_id': 65, 'u_id': 1, 'message': '65', 'time_created': 65}
    assert channel_messages_v1(1, 1, 21)['messages'][49] == {'message_id': 41, 'u_id': 1, 'message': '41', 'time_created': 41}

    # Raise an index error if trying to access beyond index 49 of ['messages']
    # as index 50 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 21)['messages'][50]
...
def test_channel_messages_v1_start_21_end_neg1():
    ...
    assert channel_messages_v1(1, 1, 21)['start'] == 21, "Start should not change"
    assert channel_messages_v1(1, 1, 21)['end'] == -1, "50 < start + 50 if so return 'end': -1"

    # The 22nd most recent message of the whole channel is the first one to be returned
    # (essentially data['messages'][21] - the 21st index)
    assert channel_messages_v1(1, 1, 21)['messages'][0] == {'message_id': 29, 'u_id': 1, 'message': '29', 'time_created': 29}
    assert channel_messages_v1(1, 1, 21)['messages'][25] == {'message_id': 4, 'u_id': 2, 'message': '4', 'time_created': 4}
    assert channel_messages_v1(1, 1, 21)['messages'][28] == {'message_id': 1, 'u_id': 1, 'message': '1', 'time_created': 1}

    # Raise an index error if trying to access beyond index 28 of ['messages']
    # as index 29 is meant to be out of range
    with pytest.raises(IndexError):
        assert channel_messages_v1(1, 1, 21)['messages'][29]
