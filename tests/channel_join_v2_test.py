...
def test_standard():
    ...
    channel_join_v1([a_u_id2]['token'], chid1['channel_id']) #User 2 joins channel 1 as regular member
    
    # Expect a list containing channel 1
    assert channels_list_v1([a_u_id2]['token']) == {
        'channels': [
            {
...
def test_multiple_channels_joined():
    ...
    a_u_id1 = auth_register_v1('temp1@gmail.com','password1','first1','last1') #auth_user_id1 created
    a_u_id2 = auth_register_v1('temp2@gmail.com','password2','first2','last2') #auth_user_id2 created
    chid1 = channels_create_v1([a_u_id1]['token'], 'channel1', True) #Public channel1 created
    chid2 = channels_create_v1([a_u_id1]['token'], 'channel2', True) #Public channel2 created
    chid3 = channels_create_v1([a_u_id1]['token'], 'channel3', True) #Public channel3 created
    chid4 = channels_create_v1([a_u_id1]['token'], 'channel4', True) #Public channel4 created
...
def test_multiple_joiners():
    ...
    chid1 = channels_create_v1([a_u_id1]['token'], 'channel1', True) #Public channel1 created
    channel_join_v1([a_u_id2]['token'], chid1['channel_id']) #User 2 joins channel 1 as regular member
    channel_join_v1([a_u_id3]['token'], chid1['channel_id']) #User 3 joins channel 1 as regular member
    channel_join_v1([a_u_id4]['token'], chid1['channel_id']) #User 4 joins channel 1 as regular member

    # Expecting a owner members including 1, and all members including 1-4
    assert channel_details_v1([a_u_id1]['token'], chid1['channel_id']) == {
        'name': 'channel1',
        'owner_members': [
            {
...
def test_private_channel():
    ...
    a_u_id1 = auth_register_v1('temp1@gmail.com','password1','first1','last1') #auth_user_id1 created
    a_u_id2 = auth_register_v1('temp2@gmail.com','password2','first2','last2') #auth_user_id2 created
    chid1 = channels_create_v1([a_u_id1]['token'], 'channel1', False) #Private channel created

    with pytest.raises(AccessError):
        channel_join_v1([a_u_id2]['token'], chid1['channel_id']) #Channel_id1 is a private channel
...
def test_invalid_channel():
    ...
    a_u_id1 = auth_register_v1('temp1@gmail.com','password1','first1','last1') #auth_user_id1 created
    a_u_id2 = auth_register_v1('temp2@gmail.com','password2','first2','last2') #auth_user_id2 created
    channels_create_v1([a_u_id1]['token'], 'channel1', True) #Public channel created

    with pytest.raises(InputError):
        channel_join_v1([a_u_id2]['token'], 123) #Channel_id2 doesn't exist
