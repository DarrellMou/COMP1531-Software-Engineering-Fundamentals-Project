...
def test_function():
    ...
    assert dm_create_v1(auth_decode_token(a_u_id1['token']), [a_u_id1['auth_user_id'], a_u_id2['auth_user_id']]) == {
        'dm_id': data[a_u_id1['auth_user_id']]['dms'[0]],
...
def test_multiple():
    ...
    assert dm_create_v1(auth_decode_token(a_u_id1['token']), [a_u_id1['auth_user_id'], a_u_id2['auth_user_id'], a_u_id3['auth_user_id'], a_u_id4['auth_user_id'], a_u_id5['auth_user_id']]) == {
        'dm_id': data[a_u_id1['auth_user_id']]['dms'[0]],
