...
def users(reset):
    ...
    # a_u_id* has two fields: token and auth_user_id
    a_u_id0 = auth_register_v1('user1@email.com', 'User1_pass!', 'user1_first', 'user1_last')
    a_u_id1 = auth_register_v1('user2@email.com', 'User2_pass!', 'user2_first', 'user2_last')
    a_u_id2 = auth_register_v1('user3@email.com', 'User3_pass!', 'user3_first', 'user3_last')
    a_u_id3 = auth_register_v1('user4@email.com', 'User4_pass!', 'user4_first', 'user4_last')
    a_u_id4 = auth_register_v1('user5@email.com', 'User5_pass!', 'user5_first', 'user5_last')
