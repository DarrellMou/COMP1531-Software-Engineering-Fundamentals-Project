...
from src.channel import channel_join_v1, channel_details_v2
...
def test_multiple_channels_owner():
    ...
    a_u_id1 = auth_register_v1('temp1@gmail.com','password1','first1','last1') #auth_user_id1 created
    a_u_id2 = auth_register_v1('temp2@gmail.com','password2','first2','last2') #auth_user_id2 created
    channels_create_v2(a_u_id1['token'], 'channel1', True) #Public channel1 created, owner: user1
    chid2 = channels_create_v2(a_u_id2['token'], 'channel2', True) #Public channel2 created, owner: user2
    chid3 = channels_create_v2(a_u_id2['token'], 'channel3', True) #Public channel3 created, owner: user2
    chid4 = channels_create_v2(a_u_id2['token'], 'channel4', True) #Public channel4 created, owner: user2
    chid5 = channels_create_v2(a_u_id2['token'], 'channel5', True) #Public channel5 created, owner: user2
    chid6 = channels_create_v2(a_u_id2['token'], 'channel6', True) #Public channel6 created, owner: user2
    chid7 = channels_create_v2(a_u_id2['token'], 'channel7', True) #Public channel7 created, owner: user2
...
def test_multiple_channels_regmember():
    ...
    a_u_id2 = auth_register_v1('temp2@gmail.com','password2','first2','last2') #auth_user_id2 created
    channels_create_v2(a_u_id1['token'], 'channel1', True) #Public channel1 created, owner: user1
    chid2 = channels_create_v2(a_u_id1['token'], 'channel2', True) #Public channel2 created, owner: user1
    chid3 = channels_create_v2(a_u_id1['token'], 'channel3', True) #Public channel3 created, owner: user1
    chid4 = channels_create_v2(a_u_id1['token'], 'channel4', True) #Public channel4 created, owner: user1
    chid5 = channels_create_v2(a_u_id1['token'], 'channel5', True) #Public channel5 created, owner: user1
    chid6 = channels_create_v2(a_u_id1['token'], 'channel6', True) #Public channel6 created, owner: user1
    chid7 = channels_create_v2(a_u_id1['token'], 'channel7', True) #Public channel7 created, owner: user1
    channel_join_v1(a_u_id2['auth_user_id'], chid2['channel_id']) #User 2 joins channel 2 as regular member
    ...
    channel_join_v1(a_u_id2['auth_user_id'], chid5['channel_id']) #User 2 joins channel 5 as regular member
    channel_join_v1(a_u_id2['auth_user_id'], chid6['channel_id']) #User 2 joins channel 6 as regular member
