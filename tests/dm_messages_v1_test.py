...
def send_x_message(user, dm, num_messages):
    ...
    while message_count < num_messages:
        ...
        m_id = message_senddm_v1(user, dm, str(message_num))
...
def send_x_messages_two_users(user1, user2, dm, num_messages):
    ...
    while message_count < num_messages:
        ...
        if message_count % 2 == 0:
            m_id = message_senddm_v1(user1, dm, str(message_num))
        else:
            m_id = message_senddm_v1(user2, dm, str(message_num))
...
def test_dm_messages_v1_default_Access_Error():

    with pytest.raises(AccessError):
        dm_messages_v1("Invalid token", 12377471, 0)
...
def test_dm_messages_v1_1_message():
    ...
    msg_list = send_x_message(user1, dm1, 1)
    ...
    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message_id"] == msg_list[0]["message_id"]
...
def test_dm_messages_v1_50_messages():
    ...
    # Add 50 messages
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 50)
    ...
    assert dm_messages_v1(user1, dm1, 0)['messages'][49]["message_id"] ==\
        msg_id_list[0]["message_id"], "Error, messages do not match"
    
    assert dm_messages_v1(user1, dm1, 0)['messages'][34]["message_id"] ==\
        msg_id_list[15]["message_id"], "Error, messages do not match"
    
    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message_id"] ==\
        msg_id_list[49]["message_id"], "Error, messages do not match"
...
def test_dm_messages_v1_100_messages_start_50():
    ...
    # Add 100 messages
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 100)
    ...
    assert dm_messages_v1(user1, dm1, 50)['messages'][0]["message_id"] ==\
        msg_id_list[49]["message_id"]

    assert dm_messages_v1(user1, dm1, 50)['messages'][49]["message_id"] ==\
        msg_id_list[0]["message_id"]

    assert dm_messages_v1(user1, dm1, 50)['messages'][0]["message"] == "50"

    assert dm_messages_v1(user1, dm1, 50)['messages'][49]["message"] == "1"
...
def test_dm_messages_start_is_last_message():
    ...
    # Add 10 messages
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 10)
    ...
    assert dm_messages_v1(user1, dm1, 9)['messages'][0]["message_id"] ==\
        msg_id_list[0]["message_id"]
    
    assert dm_messages_v1(user1, dm1, 9)['messages'][0]["message"] == "1"
...
def test_dm_messages_v1_48_messages():
    ...
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 48)
    ...
    assert dm_messages_v1(user1, dm1, 0)['messages'][47]["message_id"] ==\
        msg_id_list[0]["message_id"]

    assert dm_messages_v1(user1, dm1, 0)['messages'][47]["message"] == "1"

    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message_id"] ==\
        msg_id_list[47]["message_id"]

    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message"] == "48"

    assert dm_messages_v1(user1, dm1, 0)['messages'][15]["message"] == "33"
...
def test_dm_messages_v1_51_messages_start_0():
    ...
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 51)
    ...
    assert dm_messages_v1(user1, dm1, 0)['messages'][49]["message_id"] ==\
        msg_id_list[1]["message_id"]

    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message_id"] ==\
        msg_id_list[50]["message_id"]
...
def test_dm_messages_v1_111_messages_start_0():
    ...
    msg_id_list = send_x_messages_two_users(user1, user2, dm1, 111)
    ...
    assert dm_messages_v1(user1, dm1, 0)['messages'][0]["message_id"] ==\
        msg_id_list[110]["message_id"]

    assert dm_messages_v1(user1, dm1, 0)['messages'][25]["message_id"] ==\
        msg_id_list[85]["message_id"]

    assert dm_messages_v1(user1, dm1, 0)['messages'][49]["message_id"] ==\
        msg_id_list[61]["message_id"]
...
def test_dm_messages_v1_111_messages_start_50():
    ...
    assert dm_messages_v1(user1, dm1, 50)['messages'][0]["message_id"] ==\
        msg_id_list[60]["message_id"]

    assert dm_messages_v1(user1, dm1, 50)['messages'][25]["message_id"] ==\
        msg_id_list[35]["message_id"]

    assert dm_messages_v1(user1, dm1, 50)['messages'][49]["message_id"] ==\
        msg_id_list[11]["message_id"]
...
def test_dm_messages_v1_111_messages_start_100():
    ...
    assert dm_messages_v1(user1, dm1, 100)['messages'][0]["message_id"] ==\
        msg_id_list[10]["message_id"]

    assert dm_messages_v1(user1, dm1, 100)['messages'][5]["message_id"] ==\
        msg_id_list[5]["message_id"]

    assert dm_messages_v1(user1, dm1, 100)['messages'][10]["message_id"] ==\
        msg_id_list[0]["message_id"]
...
def test_dm_messages_v1_start_21():
    ...
    assert dm_messages_v1(user1, dm1, 21)['messages'][0]["message_id"] ==\
        msg_id_list[89]["message_id"]

    assert dm_messages_v1(user1, dm1, 21)['messages'][25]["message_id"] ==\
        msg_id_list[64]["message_id"]

    assert dm_messages_v1(user1, dm1, 21)['messages'][49]["message_id"] ==\
        msg_id_list[40]["message_id"]
...
def test_dm_messages_v1_start_21_end_neg1():
    ...
    assert dm_messages_v1(user1, dm1, 21)['messages'][0]["message_id"] ==\
        msg_id_list[28]["message_id"]

    assert dm_messages_v1(user1, dm1, 21)['messages'][25]["message_id"] ==\
        msg_id_list[3]["message_id"]
    
    assert dm_messages_v1(user1, dm1, 21)['messages'][28]["message_id"] ==\
        msg_id_list[0]["message_id"]
