...
############################# EXCEPTION TESTING ##############################
def test_http_message_send_v2_AccessError(set_up_data):
    setup = set_up_data
...
def test_http_message_send_v2_InputError(set_up_data):
    setup = set_up_data
...
def test_http_message_send_v2_send_one(set_up_data):
    setup = set_up_data
    user1, channel1 = setup['user1'], setup['channel1']
...
def test_http_message_send_v2_user_sends_identical_messages(set_up_data):
    setup = set_up_data
    user1, channel1 = setup['user1'], setup['channel1']
...
# being sent
def test_http_message_send_v2_multiple_users_multiple_messages(set_up_data):
    setup = set_up_data
...
def test_http_message_send_v2_multiple_users_multiple_messages_message_id(set_up_data):
    setup = set_up_data
    user1, user2, channel1 = setup['user1'], setup['user2'], setup['channel1']
...
def test_http_message_send_v2_identical_message_to_2_channels(set_up_data):
    setup = set_up_data
    user1, channel1 = setup['user1'], setup['channel1']
...
def test_http_message_send_v2_appends_to_data_messages(set_up_data):
    setup = set_up_data
    user1, channel1 = setup['user1'], setup['channel1']
