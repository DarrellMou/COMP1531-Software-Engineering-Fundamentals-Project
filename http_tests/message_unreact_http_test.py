...
def test_message_unreact_v1_channel(setup_user_data):
    ...
    assert channel1_details['messages'][0]["reactions"][0]["is_removed"] == False
    ...
    # Check that channel details have all been set correctly
    channel1_details2 = requests.get(config.url + 'channel/details/v2', params={
        'token': users['user1']['token'],
        'channel_id': channel_id1['channel_id'],
    }).json()

    assert channel1_details2['messages'][0]["reactions"][0]["is_removed"] == True
...
def test_message_unreact_v1_dm(setup_user_data):
    ...
    assert dm1_details['messages'][0]["reactions"][0]["is_removed"] == False
    ...
    # Check that channel details have all been set correctly
    dm1_details2 = requests.get(config.url + 'dm/details/v1', params={
        'token': users['user1']['token'],
        'dm_id': dm_id1['dm_id'],
    }).json()

    assert dm1_details2['messages'][0]["reactions"][0]["is_removed"] == True
...
def test_message_unreact_v1_different_messages(setup_user_data):
    ...
    assert channel1_details2['messages'][0]["reactions"][0]["is_removed"] == False
    assert channel1_details2['messages'][1]["reactions"][0]["is_removed"] == True
...
def test_message_unreact_v1_multiple_reacts(setup_user_data):
    ...
    assert channel1_details2['messages'][0]["reactions"][0]["is_removed"] == True
    assert channel1_details2['messages'][1]["reactions"][0]["is_removed"] == False
    assert channel1_details2['messages'][1]["reactions"][0]["is_removed"] == False
