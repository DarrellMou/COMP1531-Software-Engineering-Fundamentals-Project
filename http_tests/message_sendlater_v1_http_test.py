...
def test_http_message_sendlater_v1_AccessError():
    setup = set_up_data()
...
def test_http_message_sendlater_v1_InputError():
    setup = set_up_data()
...
def test_http_message_sendlater_v1_InputError_invalid_channel():
    setup = set_up_data()
    user1 = setup['user1']
...
def test_http_message_sendlater_v1_InputError_invalid_time():
    setup = set_up_data()
    user1, channel1 = setup['user1'], setup['channel1']
...
def test_http_message_send_later_v1_1_message():
    setup = set_up_data()
    user1, channel1 = setup['user1'], setup['channel1']
...
def test_http_message_send_later_v1_send_multiple_after():
    setup = set_up_data()
...
# the message is sent
def test_http_message_send_later_v1_leave_channel_before_message_sent():
    setup = set_up_data()
    user1, user2, channel1 = setup['user1'], setup['user2'], setup['channel1']
    requests.post(f"{url}channel/invite/v2", json=channel_invite_body(user1, channel1, user2)).json()
