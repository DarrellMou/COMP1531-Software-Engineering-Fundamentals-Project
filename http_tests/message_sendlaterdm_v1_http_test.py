...
# Simple data population helper function; registers users 1, 2 and 3,
# creates dm_1 with member u_id = 1
def set_up_data():
    requests.delete(f"{url}clear/v1")
    # Populate data - create/register users 1 and 2 and have user 1 make dm1 with user2
    ...
    user3 = requests.post(f"{url}auth/register/v2", json=user_body(3)).json()
...
def test_http_message_sendlaterdm_v1_AccessError():
    setup = set_up_data()
...
def test_http_message_sendlaterdm_v1_InputError():
    setup = set_up_data()
...
def test_http_message_sendlaterdm_v1_InputError_invalid_dm():
    setup = set_up_data()
    user1 = setup['user1']
...
def test_http_message_sendlaterdm_v1_InputError_invalid_time():
    setup = set_up_data()
    user1, dm1 = setup['user1'], setup['dm1']
...
def test_http_message_sendlaterdm_v1_1_message():
    setup = set_up_data()
    user1, dm1 = setup['user1'], setup['dm1']
...
def test_http_message_sendlaterdm_v1_send_multiple_after():
    setup = set_up_data()
...
# the message is sent
def test_http_message_sendlaterdm_v1_leave_dm_before_message_sent():
    setup = set_up_data()
    user1, user3, dm1 = setup['user1'], setup['user3'], setup['dm1']
    requests.post(f"{url}dm/invite/v1", json=dm_invite_body(user1, dm1, user3)).json()
